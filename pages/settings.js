                ...
                {activeTab === 'privacy' && (
                    <div className="bg-white rounded-2xl shadow-lg p-8 animate-fadeIn">
                      ...
                      <button
                          ...
                          disabled={saving}
                          className="w-full mt-6 px-6 py-3 bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-xl font-semibold hover:from-primary-700 hover:to-purple-700 transition-all shadow-lg disabled:opacity-50"
                      >
                          ...
                          <span className="inline-flex items-center px-4 py-2 bg-green-100 text-green-800 rounded-lg font-semibold">
                            ✓ Connected
                                ...
                                <button
                                    ...
                                    className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-blue-800 transition-all shadow-md"
                                >
                                  Connect Telegram
                                </button>
                            )}
